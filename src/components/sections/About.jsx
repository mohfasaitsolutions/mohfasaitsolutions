        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-base md:text-lg text-[#52525B] leading-relaxed">
              At Mohfasa IT Solutions, we build technology that solves real business challenges. Whether you need custom software, AI-powered automation, scalable cloud infrastructure, or digital growth strategies, we deliver solutions that create measurable business value.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
              <div className="bg-white border border-black/10 p-5 rounded-[20px] space-y-2 shadow-sm hover:border-[#2563EB] transition-colors">
          ...
          <div className="lg:col-span-5 bg-white border border-black/10 rounded-[20px] p-8 space-y-6 shadow-md">
            <div className="flex items-center gap-3">
              <FiLayers className="w-6 h-6 text-[#2563EB]" />
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {audienceIndustries.map((industry, idx) => (
                <div
                  key={idx}
                  className="inline-flex items-center gap-2 px-3.5 py-2 bg-[#F4F4F5] border border-black/5 rounded-full text-xs font-medium text-[#09090B] hover:border-[#2563EB] transition-colors"
                >
