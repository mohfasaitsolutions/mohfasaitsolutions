        ...
        <div className="flex gap-6 animate-marquee whitespace-nowrap min-w-full flex-shrink-0">
          {stack.concat(stack).map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="inline-flex items-center gap-3 px-6 py-3 bg-white border border-black/10 rounded-md text-sm font-medium text-[#09090B] shadow-xs hover:border-[#2563EB] transition-colors"
              >
